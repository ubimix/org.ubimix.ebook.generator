 ...
 * @author kotelnikov
 */
public class SimplePageFormatter extends AbstractPageFormatter {

    public SimplePageFormatter(InnerPagePresenter presenter, Uri baseResourceUri) {
